...
def main():
    ...
    parser.add_argument("--redshift", default="4.4")
    parser.add_argument("--dataset_dir", default="dataset_files_z4.4")
    ...
    parser.add_argument("--trails", default="30")
    ...
    parser.add_argument('--load_best_model', action='store_true', default=True)
