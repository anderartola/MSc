...
class ConvLayer(keras.Model):
    ...
    def call(self, inputs):
        ...
        # with open("/Users/ander/Desktop/Master/ML/bh2igm/ml_outputs_mflux0.3216_fwhm6.00_z4.40/Layers_output.npy", 'ab') as f:
        #     np.save(f,x)
        # print("layer weights",self.conv.get_weights()[0].shape)
        # print("layer weights",self.conv.get_weights()[0][:,0,2])
        
        # print("-----------------------------")
        # print("CNN layer output: ",x.shape)
